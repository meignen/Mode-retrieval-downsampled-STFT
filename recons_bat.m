...
for k=1:nbreal
 ...
 %with different downsampling values
  ...
  %0 dB
  [SNR_modes_0(k),inter_moy_0(k,:),coeff_util_0(k,:)]    = reconstruct_modes_nr(3,'Hamming',0,16,nr);
  [SNR_modes1_0(k),inter_moy1_0(k,:),coeff_util1_0(k,:)] = reconstruct_modes_nr(3,'Hamming',0,8,nr);
  [SNR_modes2_0(k),inter_moy2_0(k,:),coeff_util2_0(k,:)] = reconstruct_modes_nr(3,'hamming',0,4,nr);
    
  %5 dB
  [SNR_modes_5(k),inter_moy_5(k,:),coeff_util_5(k,:)]    = reconstruct_modes_nr(3,'Hamming',5,16,nr);
  [SNR_modes1_5(k),inter_moy1_5(k,:),coeff_util1_5(k,:)] = reconstruct_modes_nr(3,'Hamming',5,8,nr);
  [SNR_modes2_5(k),inter_moy2_5(k,:),coeff_util2_5(k,:)] = reconstruct_modes_nr(3,'Hamming',5,4,nr);
 
  %10 dB
  [SNR_modes_10(k),inter_moy_10(k,:),coeff_util_10(k,:)]    = reconstruct_modes_nr(3,'Hamming',10,16,nr);
  [SNR_modes1_10(k),inter_moy1_10(k,:),coeff_util1_10(k,:)] = reconstruct_modes_nr(3,'Hamming',10,8,nr);
  [SNR_modes2_10(k),inter_moy2_10(k,:),coeff_util2_10(k,:)] = reconstruct_modes_nr(3,'Hamming',10,4,nr);
end
