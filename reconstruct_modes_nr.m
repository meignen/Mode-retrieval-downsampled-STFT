function [SNR_modes,inter_moy,coeff_util] = reconstruct_modes_nr(sig,window,SNR,downsamp,nr)
 %INPUT
 ...
 for j=1:nr,
  ...
  for r = 1:B(2),  
   ...
   val = 3*gamma_estime; %trheshold for the transform depending on the noise level
